...
The preferred cut is approximately **1:37**, with a **9.3-second elevator pitch** followed by
...
Generated locally in `tools/clickthru/out/continuous-zpfCY5/`:

- `as-i-am-continuous.mp4` — preferred English demo, using the owner's existing ElevenLabs voice.
...
The existing voice used Multilingual v2 with a generation speed of 0.9. No new clone was made.
