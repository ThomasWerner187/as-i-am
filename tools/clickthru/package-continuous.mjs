...
<p>${escapeHtml(manifest.transport)} · No real bookings. ${escapeHtml(plan.voiceName)} via ElevenLabs (AI-generated). One continuous voice-over; screen holds edited to match.</p></main>
