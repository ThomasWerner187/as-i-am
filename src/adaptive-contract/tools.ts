...
const PAGE_DESCRIPTORS: Record<string, PageDescriptor> = {
  ...
  restaurant: {
    ...
    main_sections: ["Restaurant", "Dinner timing", "Available tables", "Menu and explicit food requirements", "Review", "Human confirmation"],
    tasks: [
      { id: "plan_dinner", description: "Find the latest listed table before the film with a walking and arrival buffer.", tool: "get_dinner_plan" },
      { id: "choose_table", description: "Find tables allowing time to eat and walk to the film.", tool: "get_available_table_times" },
      { id: "review_table", description: "Stage a table for human confirmation.", tool: "prepare_table_selection" },
      { id: "browse_menu", description: "Read source-declared prices, ingredients and allergen information.", tool: "get_restaurant_menu" },
      { id: "find_menu", description: "Research options matching explicitly supplied diet, budget and allergen requirements.", tool: "find_menu_options" },
      { id: "view_menu", description: "Show a full or focused menu with those explicit requirements.", tool: "present_menu_for_user" },
    ],
